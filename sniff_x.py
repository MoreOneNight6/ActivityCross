...
class Sniffer:
    def __init__(self):
        ...
        self.key_hook = lambda *args: None
        self.mouse_button_hook = lambda *args: None
        self.mouse_move_hook = lambda *args: None
        self.screen_hook = lambda *args: None
    ...
    def get_cur_window(self):
        ...
        #print(cur_class, cur_window, cur_name)
